...
return [
     ...
     */
    // El guard "default" de la app es "web" (config/auth.php), pero esta API
    // autentica todo con Sanctum vía middleware "auth:sanctum" — sin fijar
    // esto en "sanctum", el paquete intentaría resolver el causer contra el
    // guard equivocado y cada entrada del log quedaría con causer_id null,
    // sin registrar quién hizo el cambio.
